...
async function getSecret() {
  ...
  try {
    ...
    try {
      ...
      // Read-only filesystem (serverless / read-only deploy): keep the
      // in-memory secret. Sessions remain valid only within this process.
      // Set SESSION_SECRET to share sessions across instances/restarts.
    }
  }
